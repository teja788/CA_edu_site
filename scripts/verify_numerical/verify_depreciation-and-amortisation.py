...
def q_f1c5_001():
    ...
    key = {62_000: "D", 60_000: "A", 64_000: "B", 50_000: "C"}[charge]
...
def q_f1c5_002():
    ...
    key = {560_000: "D", 500_000: "B", 440_000: "C", 540_000: "A"}[amount]
...
def q_f1c5_003():
    ...
    key = {10.0: "C", 11.11: "D", 12.5: "B", 9.09: "A"}[rate_pct]
...
def q_f1c5_004():
    ...
    wdv1 = 500_000 * 0.9
    y2 = wdv1 * 0.10
    key = {50_000: "B", 45_000: "D", 40_500: "A", 47_500: "C"}[y2]
...
def q_f1c5_005():
    ...
    value = 100_000 * 0.8**3
    key = {40_000: "D", 51_200: "A", 48_800: "C", 64_000: "B"}[round(value)]
...
def q_f1c5_006():
    ...
    key = {50.0: "B", 29.17: "D", 12.5: "C", 87.5: "A"}[rate_pct]
    return {"answer": key, "computed": rate_pct}
...
def q_f1c5_007():
    ...
    key = {56_000: "B", 48_000: "C", 60_000: "A", 70_000: "D"}[charge]
    return {"answer": key, "computed": charge}
...
def q_f1c5_008():
    ...
    key = {30_000: "A", 22_500: "D", 15_000: "B", 25_000: "C"}[charge]
    return {"answer": key, "computed": charge}
...
def q_f1c5_010():
    ...
    wdv = 640_000 * 0.75**2
    result = 400_000 - wdv
    key = {40_000: "B", -240_000: "D", 80_000: "C", -40_000: "A"}[round(result)]
    return {"answer": key, "computed": result}
...
def q_f1c5_011():
    ...
    key = {120_000: "A", 200_000: "C", 210_000: "D", 180_000: "B"}[round(charge)]
    return {"answer": key, "computed": charge}
...
def q_f1c5_012():
    ...
    wdv = 500_000 * 0.8**2
    charge = (wdv - 40_000) / 4
    key = {70_000: "D", 80_000: "C", 76_667: "A", 64_000: "B"}[round(charge)]
    return {"answer": key, "computed": charge}
...
def q_f1c5_013():
    ...
    charge = carrying / 2
    key = {60_000: "B", 120_000: "A", 80_000: "C", 30_000: "D"}[charge]
    return {"answer": key, "computed": charge}
...
def q_f1c5_014():
    ...
    key = {80_000: "B", 96_000: "A", 160_000: "D", 60_000: "C"}[balance]
...
def q_f1c5_015():
    ...
    key = {52_500: "B", 50_000: "C", 40_000: "A", 42_000: "D"}[charge]
    return {"answer": key, "computed": charge}
...
def q_f1c5_016():
    ...
    key = {20_000: "B", 16_200: "D", 18_000: "A", 14_580: "C"}[round(y3)]
...
def q_f1c5_017():
    ...
    charge = 150_000 / 10
    key = {15_000: "A", 30_000: "C", 150_000: "B"}.get(charge, "D")
    return {"answer": key, "computed": charge}
...
def q_f1c5_018():
    ...
    key = {375_000: "B", 250_000: "C", 750_000: "A", 500_000: "D"}[charge]
    return {"answer": key, "computed": charge}
...
def q_f1c5_019():
    ...
    key = {-15_000: "C", -125_000: "B", 65_000: "D", 15_000: "A"}[result]
    return {"answer": key, "computed": result}
...
def q_f1c5_020():
    ...
    key = {450_000: "D", 500_000: "C", 75_000: "A", 550_000: "B"}[total]
...
def q_f1c5_022():
    ...
    value = 250_000 * 0.8**2
    key = {160_000: "B", 150_000: "C", 200_000: "D", 128_000: "A"}[round(value)]
    return {"answer": key, "computed": value}
...
def q_f1c5_023():
    ...
    key = {-5_500: "C", -55_000: "B", -1_000: "A", 5_500: "D"}[round(result)]
    return {"answer": key, "computed": result}
...
def q_f1c5_024():
    ...
    charge = cost * 0.25
    key = {75_000: "B", 80_000: "C", 84_000: "D", 89_000: "A"}[charge]
    return {"answer": key, "computed": charge}
