    ...
    sections: [
      ...
      },
      {
        ...
        chapters: [
          ...
          { number: 11, slug: 'companies-incorporated-outside-india', name: 'Companies Incorporated Outside India', hasNotes: true },
        ],
      },
      {
        name: 'Part I · Company Law & LLP Law — Module 3',
        chapters: [{ number: 12, slug: 'llp-act-2008', name: 'The Limited Liability Partnership Act, 2008', hasNotes: true }],
      },
      {
        name: 'Part II · Other Laws',
        chapters: [
          { number: 13, slug: 'general-clauses-act-1897', name: 'The General Clauses Act, 1897', smNumber: 'Part II Ch 1', hasNotes: true },
          { number: 14, slug: 'interpretation-of-statutes', name: 'Interpretation of Statutes', smNumber: 'Part II Ch 2', hasNotes: true },
          { number: 15, slug: 'fema-1999', name: 'The Foreign Exchange Management Act, 1999', smNumber: 'Part II Ch 3', hasNotes: true },
        ],
      },
    ],
  },
